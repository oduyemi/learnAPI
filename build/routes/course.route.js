...
router.post("/", auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)("admin"), cloudinaryStorage_1.uploadCourseThumbnail.single("thumbnail"), course_controller_1.createCourse);
...
router.patch("/:id/thumbnail", auth_middleware_1.authenticate, (0, auth_middleware_1.requireRole)("admin"), cloudinaryStorage_1.uploadCourseThumbnail.single("thumbnail"), course_controller_1.updateCourseThumbnail);
